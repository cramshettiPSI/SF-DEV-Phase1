...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        ...
        <protected>false</protected>
        <recipients>
            <recipient>pmungamuri@plan-sys.com</recipient>
            <type>user</type>
        </recipients>
        <recipients>
    ...
    <fieldUpdates>
        ...
        <formula>NOFA_RFP__r.NOFA_RFP_Summary__c</formula>
    ...
    <fieldUpdates>
        ...
        <formula>appPrefix__c + appSequence__c</formula>
        <name>popAppId</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
